...
function AdminAddBook() {
    ...
    const [imageUrl, setImageUrl] = useState(''); // Fallback if no file uploaded
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Because we're uploading files, we must use FormData
            ...
            await API.post('/book', submitData, {
        ...
        <div className="max-w-4xl mx-auto">
            <div className="mb-8 flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-500">Fill in the details to add a book to the platform</p>
                </div>
                            ...
                            <label className="flex items-center justify-between w-full p-4 border border-gray-300 dark:border-gray-700 rounded-xl cursor-pointer bg-gray-50 dark:bg-dark-hover hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="truncate max-w-[200px]">
                                        <p className="font-medium text-sm truncate">{pdfFile ? pdfFile.name : "Select PDF Document"}</p>
                                        <p className="text-xs text-gray-500">{pdfFile ? `${(pdfFile.size / 1024 / 1024).toFixed(2)} MB` : "Max size 50MB"}</p>
                                    </div>
                                </div>
